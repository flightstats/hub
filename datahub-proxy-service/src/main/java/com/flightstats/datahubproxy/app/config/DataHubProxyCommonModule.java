package com.flightstats.datahubproxy.app.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.jersey.InstrumentedResourceMethodDispatchAdapter;
import com.flightstats.datahub.app.config.metrics.PerChannelTimedMethodDispatchAdapter;
import com.flightstats.datahubproxy.app.config.metrics.GraphiteConfiguration;
...
class DataHubProxyCommonModule extends JerseyServletModule {
    ...
    static {
        ...
        JERSEY_PROPERTIES.put(PackagesResourceConfig.PROPERTY_PACKAGES, "com.flightstats.datahubproxy");
    }

    private final Properties properties;

    DataHubProxyCommonModule(Properties properties) {
