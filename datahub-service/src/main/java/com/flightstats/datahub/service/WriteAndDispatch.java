...
class WriteAndDispatch implements Callable<ValueInsertionResult> {
	...
	WriteAndDispatch(ChannelDao channelDao, ChannelInsertionPublisher channelInsertionPublisher, String channelName, byte[] data, Optional<String> contentType, Optional<String> contentLanguage) {
    ...
    public boolean equals(Object o) {
        ...
        if (channelDao != null ? !channelDao.equals(that.channelDao) : that.channelDao != null) {
            return false;
        }
        if (channelInsertionPublisher != null ? !channelInsertionPublisher.equals(
                that.channelInsertionPublisher) : that.channelInsertionPublisher != null) {
            return false;
        }
