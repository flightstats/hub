...
public class SpokeContentDaoTest {
    ...
    public void initialize() {
        ...
        hubProperties = mock(HubProperties.class);
        when(hubProperties.getSpokePath(spokeStore)).thenReturn("/spoke/write");
        String spokeStorePath = hubProperties.getSpokePath(spokeStore);
    ...
    public void getOldestItemDoesExist() {
        ...
        SpokeContentDao dao = new SpokeContentDao(commander, hubProperties);
