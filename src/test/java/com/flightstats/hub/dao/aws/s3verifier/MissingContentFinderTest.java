...
import static com.flightstats.hub.dao.aws.s3verifier.MissingContentFinder.VERIFIER_TIMEOUT_METRIC_NAME;
...
public class MissingContentFinderTest {
    ...
    public void testWithExecutionExceedingTimeout_returnsAnEmptySet_and_logsTheError() {
        ...
        verify(metricsService).increment(VERIFIER_TIMEOUT_METRIC_NAME);
    }
