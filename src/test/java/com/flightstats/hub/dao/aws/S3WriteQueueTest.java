...
public class S3WriteQueueTest {
    ...
    private S3Property s3Property = new S3Property(PropertyLoader.getInstance());
    ...
    public void testS3WriteQueue_add_dropsWhenQueueFull() {
        ...
        assertEquals(20, s3Property.getWriteQueueSize());
    ...
    public void testS3WriteQueue_add_recoversFromQueueFullWithMultipleRuns() {
        ...
        // THEN
        assertEquals(0, s3Property.getWriteQueueSize());
