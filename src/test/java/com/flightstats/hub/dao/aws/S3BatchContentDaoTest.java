...
public class S3BatchContentDaoTest {
    ...
    public void testQueryMinute() throws IOException {
        String channel = "testQueryMinute" + (new RandomStringGenerator.Builder().build()).generate(20);
    ...
    public void testQueryHour() throws IOException {
        String channel = "testQueryHour" + (new RandomStringGenerator.Builder().build()).generate(20);
    ...
    public void testPreviousEdgeCase() throws Exception {
        String channel = "testPreviousEdgeCase" + (new RandomStringGenerator.Builder().build()).generate(20);
        DateTime start = TimeUtil.now().minusHours(2);
    ...
    public void testDirectionQueryBug() throws Exception {
        String channel = "testDirectionQueryBug" + (new RandomStringGenerator.Builder().build()).generate(20);
        DateTime start = TimeUtil.now().minusHours(2);
