...
public class SequenceLastUpdatedDaoTest {
    ...
    public void testLow() throws Exception {
        keyCoordination.update("testlow", new ContentKey(2000));
        keyCoordination.update("testlow", new ContentKey(1999));
        assertEquals(2000, keyCoordination.getFromZK("testlow").value);
    }

    @Test
    public void testSame() throws Exception {
        keyCoordination.update("testSame", new ContentKey(2000));
        keyCoordination.update("testSame", new ContentKey(2000));
    ...
    public void testHigh() throws Exception {
        ...
        keyCoordination.update("testHigh", new ContentKey(2000));
        keyCoordination.update("testHigh", new ContentKey(2001));
