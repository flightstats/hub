...
public class ContentDaoUtil {
    ...
    public void testWriteHistorical() throws Exception {
        String data = (new RandomStringGenerator.Builder().build()).generate(2048);
    ...
    public void testQueryRangeDay() throws Exception {
        String channel = "testQueryRangeDay" + (new RandomStringGenerator.Builder().build()).generate(20);
    ...
    public void testQueryRangeHour() throws Exception {
        String channel = "testQueryRangeHour" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
    ...
    public void testQueryRangeMinute() throws Exception {
        String channel = "testQueryRangeMinute" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
    ...
    public void testQuery15Minutes() throws Exception {
        String channel = "testQuery15Minutes" + (new RandomStringGenerator.Builder().build()).generate(20);
        DateTime start = new DateTime(2014, 11, 14, 14, 0, DateTimeZone.UTC);
    ...
    public void testPreviousFromBulk_Issue753() throws Exception {
        String channel = "testPreviousFromBulk_Issue753" + (new RandomStringGenerator.Builder().build()).generate(20);
    ...
    public void testDirectionQueryTTL() throws Exception {
        String channel = "testDirectionQueryTTL" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
        DateTime start = TimeUtil.now();
    ...
    public void testDirectionQuery() throws Exception {
        String channel = "testDirectionQuery" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
        DateTime start = TimeUtil.now();
        create7Items(channel, keys, start);
        for (int i = 0; i < 7; i++) {
    ...
    public void testEarliest() throws Exception {
        String channel = "testEarliest" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
        DateTime start = TimeUtil.now();
        for (int i = 0; i < 60; i++) {
    ...
    public void testDeleteMaxItems() throws Exception {
        String channel = "testDeleteMaxItems" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
        DateTime start = TimeUtil.now();
        for (int i = 0; i < 5; i++) {
            ContentKey key = new ContentKey(start.minusHours(i), "A" + i);
    ...
    public void testEmptyQuery() throws Exception {
        String channel = "testEmptyQuery" + (new RandomStringGenerator.Builder().build()).generate(20);
        List<ContentKey> keys = new ArrayList<>();
