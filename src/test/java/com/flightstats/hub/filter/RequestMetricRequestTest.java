...
class RequestMetricRequestTest {
    @Value
    @Builder
    ...
    void testRequestGetRequestTemplate() {
        ...
        // WHEN
        RequestMetric.Request request = new RequestMetric.RequestBuilder(requestContext).build();
    ...
    private static Stream<Arguments> provideCasesForIsChannelRelated() {
        RequestMetric.Request.RequestBuilder builder = RequestMetric.Request.builder();
        return Stream.of(
    ...
    void testRequestIsChannelRelated(RequestMetric.Request request, boolean isChannelRelated) {
