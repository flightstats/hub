...
class ChannelLatestUpdatedStateTest extends TestSuiteClassWrapper {
    ...
    @Test
    void channelWithItemsInSpoke_returnsLatestInZkAndEndpoint() {
        channelConfigService.createWithDefaults(channelName);
        ...
        assertZookeeperLatestUpdatedItemPathEquals(expectedLastItem.getZookeeperItemPath());
    }
