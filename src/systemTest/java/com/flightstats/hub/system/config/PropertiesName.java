...
public class PropertiesName {
    ...
    public static final String SPOKE_WRITE_MINUTES = "spoke.write.ttlMinutes";
    ...
    public static final String S3_VERIFIER_OFFSET = "s3Verifier.offsetMinutes";
    ...
    public static final String ZK_NODE_COUNT = "zk.node.count";
}
