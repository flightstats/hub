...
/**
 * This is a temporary copy of LeaderSelector until we get a version with the fix for
 * https://issues.apache.org/jira/browse/CURATOR-104
 */
public class LeaderSelector implements Closeable
{
    ...
    {
        log.warn("running temporary FlightStats overlay of LeaderSelector");
