...
public class InternalS3BatchResource {
    ...
    public Response post(@PathParam("channel") String channel, String data) {
        try {
            ...
            if (shouldDropSomeWrites && Math.random() > 0.90) {
                log.debug("ignoring {} {}", channel, data);
    ...
    private boolean getAndWriteBatch(ContentDao contentDao, String channel, MinutePath path, Collection<ContentKey> keys, String batchUrl) {
