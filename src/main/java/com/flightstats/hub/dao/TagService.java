...
public class TagService {
    ...
    public SortedSet<ChannelContentKey> queryByTime(TimeQuery timeQuery) {
        ...
        for (ChannelConfig channel : channels) {
            Collection<ContentKey> contentKeys = contentRetriever.queryByTime(timeQuery.withChannelName(channel.getDisplayName()));
    ...
    public SortedSet<ChannelContentKey> getKeys(DirectionQuery query) {
        ...
        for (ChannelConfig channel : channels) {
            ...
            Collection<ContentKey> contentKeys = contentRetriever.query(query.withChannelName(channel.getDisplayName()));
