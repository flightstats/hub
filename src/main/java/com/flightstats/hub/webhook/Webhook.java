...
public class Webhook implements Comparable<Webhook>, NamedType {
    ...
    public static Webhook instanceFromTagPrototype(Webhook whp, ChannelConfig channel) {
        ...
        Webhook instance = new Webhook(whp.callbackUrl, channenUrl, whp.parallelCalls, whName, null, whp.batch, whp.heartbeat, whp.paused, whp.ttlMinutes, whp.maxWaitMinutes, whp.callbackTimeoutSeconds, whp.fastForwardable, null, whp.getTagFromTagUrl(), whp.maxAttempts);
        return instance;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this$maxAttempts == null ? other$maxAttempts != null : !this$maxAttempts.equals(other$maxAttempts))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME + ($maxAttempts == null ? 43 : $maxAttempts.hashCode());
        return result;
    }
    ...
    public Webhook withParallelCalls(Integer parallelCalls) {
        return this.parallelCalls == parallelCalls ? this : new Webhook(this.callbackUrl, this.channelUrl, parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withName(String name) {
        return this.name == name ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withStartingKey(ContentPath startingKey) {
        return this.startingKey == startingKey ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withBatch(String batch) {
        return this.batch == batch ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withHeartbeat(boolean heartbeat) {
        return this.heartbeat == heartbeat ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withPaused(boolean paused) {
        return this.paused == paused ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, paused, this.ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withTtlMinutes(Integer ttlMinutes) {
        return this.ttlMinutes == ttlMinutes ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, ttlMinutes, this.maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withMaxWaitMinutes(Integer maxWaitMinutes) {
        return this.maxWaitMinutes == maxWaitMinutes ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, maxWaitMinutes, this.callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, this.maxAttempts);
    }
    ...
    public Webhook withTag(String tag) {
        return this.managedByTag == tag ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, tag, this.maxAttempts);
    }

    public Webhook withTagUrl(String tagUrl) {
        return this.tagUrl == tagUrl ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, callbackTimeoutSeconds, this.fastForwardable, tagUrl, this.managedByTag, this.maxAttempts);
    }

    public Webhook withMaxAttempts(Integer maxAttempts) {
        return this.maxAttempts == maxAttempts ? this : new Webhook(this.callbackUrl, this.channelUrl, this.parallelCalls, this.name, this.startingKey, this.batch, this.heartbeat, this.paused, this.ttlMinutes, this.maxWaitMinutes, callbackTimeoutSeconds, this.fastForwardable, this.tagUrl, this.managedByTag, maxAttempts);
    }
    ...
    public static class WebhookBuilder {
        ...
        public Webhook.WebhookBuilder maxAttempts(Integer maxAttempts) {
            this.maxAttempts = maxAttempts;
            return this;
        }

        public Webhook build() {
            return new Webhook(callbackUrl, channelUrl, parallelCalls, name, startingKey, batch, heartbeat, paused, ttlMinutes, maxWaitMinutes, callbackTimeoutSeconds, fastForwardable, tagUrl, tag, maxAttempts);
        }
