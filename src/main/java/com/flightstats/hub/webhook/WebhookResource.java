...
public class WebhookResource {
    ...
    public Response getWebhooks() {
        return getWebhooks("webhooks");
    }

    Response getWebhooks(String listName) {
        ObjectNode root = mapper.createObjectNode();
        ObjectNode links = addSelfLink(root);
        ArrayNode groupsNode = links.putArray(listName);
        ...
        for (Group group : groups) {
            ...
            groupObject.put("href", uriInfo.getRequestUri() + "/" + group.getName());
        }
