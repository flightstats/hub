...
public class SafeZooKeeperUtils {
    ...
    @Inject
    public SafeZooKeeperUtils(CuratorFramework curator, ZooKeeperState zooKeeperState) {
        this.curator = curator;
        this.zooKeeperState = zooKeeperState;
    }

    public CuratorLock createLock(String... pathParts) {
        return new CuratorLock(curator, zooKeeperState, getPath(newArrayList(pathParts)));
    }
