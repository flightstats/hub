...
public class Influxdb {
    private final static Logger logger = LoggerFactory.getLogger(Influxdb.class);
    ...
    public int sendRequest(boolean throwExc, boolean printJson) throws Exception {
        ...
        try {
            ...
            logger.info(con.getClass().toString());
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                logger.warn("Server returned HTTP response code: " + responseCode + "for URL: " + url + " with content :'" + con.getResponseMessage() + "'");
                logger.warn(con.toString());
