...
public class CassandraValueWriter {
    ...
    private final RowKeyStrategy<String, String, DataHubCompositeValue> rowKeyStrategy;
    private final DataHubKeyGenerator keyGenerator;

    @Inject
    public CassandraValueWriter(CassandraConnector connector, HectorFactoryWrapper hector, RowKeyStrategy<String, String, DataHubCompositeValue> rowKeyStrategy, DataHubKeyGenerator keyGenerator) {
